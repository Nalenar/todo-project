...
const TodoItem = (props) => {
  ...
  const handleCompleteClick = () => {
    dispatch(toggleComplete({ id: props.todo.id, completed: !props.todo.completed}))
  };
  ...
  return (
    <div className="mx-3 mt-3 h-12 flex items-center shadow-md border border-gray-200 rounded last-of-type:mb-2">
      ...
      <div onClick={handleDeleteClick} className="h-[30px] w-[30px] flex justify-center items-center cursor-pointer mx-3">
